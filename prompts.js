...
const BUILTIN_PROMPTS = [
  // --- MEMES ---
  { id: 'meme-distracted-bf', cat: 'meme', emoji: '👀', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'meme-woman-cat', cat: 'meme', emoji: '🐱', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'meme-drake', cat: 'meme', emoji: '🙅', difficulty: 1, image: 'images/g7.jpg',
    title: 'Drakeposting',
  ...
  { id: 'meme-this-is-fine', cat: 'meme', emoji: '🔥', difficulty: 2, image: 'images/g7.jpg',
    title: '« This is fine »',
  ...
  { id: 'meme-success-kid', cat: 'meme', emoji: '👊', difficulty: 1, image: 'images/g7.jpg',
    title: 'Success Kid',
    desc: "Poing serré levé devant soi, sourcils froncés, air de triomphe absolu façon bébé qui vient de réussir un exploit." },
  { id: 'meme-side-eye', cat: 'meme', emoji: '😒', difficulty: 1, image: 'images/g7.jpg',
  ...
  { id: 'meme-ancient-aliens', cat: 'meme', emoji: '🛸', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'meme-galaxy-brain', cat: 'meme', emoji: '🧠', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'meme-hide-pain-harold', cat: 'meme', emoji: '🙂', difficulty: 1, image: 'images/g7.jpg',
  ...
  { id: 'meme-shocked-pikachu', cat: 'meme', emoji: '😲', difficulty: 1, image: 'images/g7.jpg',
  ...
  // --- FILMS ---
  { id: 'film-titanic-flying', cat: 'film', emoji: '🚢', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'film-lion-king', cat: 'film', emoji: '🦁', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'film-matrix-dodge', cat: 'film', emoji: '🕶️', difficulty: 3, image: 'images/g7.jpg',
  ...
  { id: 'film-rocky-steps', cat: 'film', emoji: '🥊', difficulty: 1, image: 'images/g7.jpg',
  ...
  { id: 'film-dirty-dancing-lift', cat: 'film', emoji: '💃', difficulty: 3, image: 'images/g7.jpg',
  ...
  { id: 'film-home-alone-scream', cat: 'film', emoji: '😱', difficulty: 1, image: 'images/g7.jpg',
    title: 'Maman, j\'ai raté l\'avion !',
    desc: "Mains plaquées sur les joues, bouche grande ouverte, yeux écarquillés façon cri muet de panique/excitation." },
  { id: 'film-pulp-fiction-dance', cat: 'film', emoji: '✌️', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'film-grease-finale', cat: 'film', emoji: '🎸', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'film-mona-lisa', cat: 'film', emoji: '🖼️', difficulty: 1, image: 'images/g7.jpg',
    title: 'La Joconde',
    desc: "Mains croisées devant soi, léger sourire énigmatique, tête légèrement penchée, regard fixe vers l'objectif." },
  { id: 'film-scream-mask', cat: 'film', emoji: '🔪', difficulty: 1, image: 'images/g7.jpg',
  ...
  { id: 'film-avengers-assemble', cat: 'film', emoji: '🛡️', difficulty: 3, image: 'images/g7.jpg',
  ...
  // --- SÉRIES ---
  { id: 'serie-friends-couch', cat: 'serie', emoji: '☕', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'serie-office-jim', cat: 'serie', emoji: '📎', difficulty: 1, image: 'images/g7.jpg',
  ...
  { id: 'serie-stranger-things', cat: 'serie', emoji: '🩸', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'serie-got-throne', cat: 'serie', emoji: '👑', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'serie-squid-game', cat: 'serie', emoji: '🦑', difficulty: 2, image: 'images/g7.jpg',
  ...
  { id: 'serie-breaking-bad', cat: 'serie', emoji: '🧪', difficulty: 2, image: 'images/g7.jpg',
